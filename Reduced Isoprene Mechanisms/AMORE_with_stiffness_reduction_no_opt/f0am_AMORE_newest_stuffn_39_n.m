...
i=i+1;
Rnames{i} = 'MACR + OH = MVK3OO4OH + CO2 + O3 + NO2 + MPAN + CH3OO + HCHO + CH3CO3 + HO2 + CO + HNO3';
k(:,i) = 8.0E-12.*exp(380./T).*0.53.*1.9016976262891332;
Gstr{i,1} = 'MACR'; Gstr{i,2} = 'OH'; 
fMACR(i)=fMACR(i)-1; fOH(i)=fOH(i)-1; fMVK3OO4OH(i)=fMVK3OO4OH(i)+0.5456891961744642; fCO2(i)=fCO2(i)+0.3912865428952396; fO3(i)=fO3(i)+0.009846629872643156; fNO2(i)=fNO2(i)+1.1739127887525573; fMPAN(i)=fMPAN(i)+0.06805172398029857; fCH3OO(i)=fCH3OO(i)+0.010130786310636176; fHCHO(i)=fHCHO(i)+0.41998246132148453; fCH3CO3(i)=fCH3CO3(i)+0.005455038782650248; fHO2(i)=fHO2(i)+0.8632324659141617; fCO(i)=fCO(i)+0.3411919404360621; fHNO3(i)=fHNO3(i)+0.003428082725824069; 
...
i=i+1;
Rnames{i} = 'IHN = OH + NO2 + CO + HO2 + CH3CO3 + GLYX + MGLY + CO2 + PYRAC + HCOOH + GLYC + HCHO + MVK3OO4OH + HAC + MPAN';
k(:,i) = 0.455.*0.55.*SUN.*4.0E-4.*0.04407913213234748;
Gstr{i,1} = 'IHN'; 
fIHN(i)=fIHN(i)-1; fOH(i)=fOH(i)+1.4186461892783433; fNO2(i)=fNO2(i)+1.328799288607202; fCO(i)=fCO(i)+1.5196155237775275; fHO2(i)=fHO2(i)+0.7496498403099923; fCH3CO3(i)=fCH3CO3(i)+0.1565609015576309; fGLYX(i)=fGLYX(i)+0.1399733863640397; fMGLY(i)=fMGLY(i)+0.37002868467554983; fCO2(i)=fCO2(i)+0.04656793168044886; fPYRAC(i)=fPYRAC(i)+0.25053961653261025; fHCOOH(i)=fHCOOH(i)+0.10909244657014404; fGLYC(i)=fGLYC(i)+0.010396781391206707; fHCHO(i)=fHCHO(i)+0.02305222413016572; fMVK3OO4OH(i)=fMVK3OO4OH(i)+0.25770167962592877; fHAC(i)=fHAC(i)+0.017653699132477354; fMPAN(i)=fMPAN(i)+0.0014378101034350605; 
...
k(:,i) = 3.6E-13.*1.279069226315369e-09;
...
i=i+1;
Rnames{i} = 'ISOP1OHt + O2 = ISOP1OH2OO';
k(:,i) = 7.5E-13.*1.279069226315369e-09;
Gstr{i,1} = 'ISOP1OHt'; Gstr{i,2} = 'O2'; 
fISOP1OHt(i)=fISOP1OHt(i)-1; fO2(i)=fO2(i)-1; fISOP1OH2OO(i)=fISOP1OH2OO(i)+1.0; 
...
i=i+1;
Rnames{i} = 'ISOP1OHc + O2 = ISOP1OH2OO';
k(:,i) = 1.4E-13.*1.279069226315369e-09;
Gstr{i,1} = 'ISOP1OHc'; Gstr{i,2} = 'O2'; 
fISOP1OHc(i)=fISOP1OHc(i)-1; fO2(i)=fO2(i)-1; fISOP1OH2OO(i)=fISOP1OH2OO(i)+1.0; 
...
k(:,i) = 4.9E-13.*1.4758491072869646e-09;
...
i=i+1;
Rnames{i} = 'ISOP4OHt + O2 = ISOP3OO4OH';
k(:,i) = 6.5E-13.*1.4758491072869646e-09;
Gstr{i,1} = 'ISOP4OHt'; Gstr{i,2} = 'O2'; 
fISOP4OHt(i)=fISOP4OHt(i)-1; fO2(i)=fO2(i)-1; fISOP3OO4OH(i)=fISOP3OO4OH(i)+1.0; 
...
i=i+1;
Rnames{i} = 'ISOP4OHc + O2 = ISOP3OO4OH';
k(:,i) = 2.1E-13.*1.4758491072869646e-09;
Gstr{i,1} = 'ISOP4OHc'; Gstr{i,2} = 'O2'; 
fISOP4OHc(i)=fISOP4OHc(i)-1; fO2(i)=fO2(i)-1; fISOP3OO4OH(i)=fISOP3OO4OH(i)+1.0; 
