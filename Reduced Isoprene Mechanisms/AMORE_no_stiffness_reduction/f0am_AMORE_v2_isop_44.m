...
fISOP3OO4OH(i)=fISOP3OO4OH(i)-1; fISOP1OH2OO(i)=fISOP1OH2OO(i)-1; fMACR(i)=fMACR(i)+0.7056754321133859; fHO2(i)=fHO2(i)+1.6798402931444318; fHCHO(i)=fHCHO(i)+0.8223419010710656; fCO(i)=fCO(i)+1.5325630806786357; fCH3CO3(i)=fCH3CO3(i)+0.5662051013652106; fOH(i)=fOH(i)+1.6412575545405201; fGLYC(i)=fGLYC(i)+0.30932244379912743; fMGLY(i)=fMGLY(i)+0.16032009892872667; fGLYX(i)=fGLYX(i)+0.030401477005879796; fCO2(i)=fCO2(i)+0.2641324114474611; fNO2(i)=fNO2(i)+0.10943077727067503; fTETRA(i)=fTETRA(i)+0.1024453549646962; fISOPN(i)=fISOPN(i)+0.0029701555254977247; fHAC(i)=fHAC(i)+0.317354213611797; 
...
Gstr{i,1} = 'ISOP3OO4OH'; 
fISOP3OO4OH(i)=fISOP3OO4OH(i)-1; fHO2(i)=fHO2(i)+0.7472883023445236; fOH(i)=fOH(i)+1.6591728894884479; fCO(i)=fCO(i)+1.0201894702822112; fGLYX(i)=fGLYX(i)+0.03635271849288182; fCH3CO3(i)=fCH3CO3(i)+0.09879024481719767; fMGLY(i)=fMGLY(i)+0.37631492411852707; fPYRAC(i)=fPYRAC(i)+0.05299813357980883; fCO2(i)=fCO2(i)+0.11394479943825517; fTETRA(i)=fTETRA(i)+0.08183146013010195; fHCHO(i)=fHCHO(i)+0.3471619521048121; fHAC(i)=fHAC(i)+0.0037301367661807354; fNO2(i)=fNO2(i)+0.09939182164011111; fMVK3OO4OH(i)=fMVK3OO4OH(i)+0.03933622129007283; fMACR(i)=fMACR(i)+0.18782665136575422; 
...
fISOP1OH2OOH(i)=fISOP1OH2OOH(i)-1; fOH(i)=fOH(i)-1; fISOP1OH23O4OHt(i)=fISOP1OH23O4OHt(i)+0.7956701949903247; fHAC(i)=fHAC(i)+0.029026784481675123; fNO2(i)=fNO2(i)+0.016095582617092725; fTETRA(i)=fTETRA(i)+0.14936788290899783; fGLYC(i)=fGLYC(i)+0.004463734071826945; fHCHO(i)=fHCHO(i)+0.01982952784483502; fHO2(i)=fHO2(i)+0.04651287365461044; fISOPN(i)=fISOPN(i)+0.0023516861915089627; fCO(i)=fCO(i)+0.056124280935175894; fGLYX(i)=fGLYX(i)+0.005950758899156969; fMVK(i)=fMVK(i)+0.005980606528853196; fCH3CO3(i)=fCH3CO3(i)+0.0017427703537092212; fMGLY(i)=fMGLY(i)+0.014948606477577496; fCO2(i)=fCO2(i)+0.0027264642279197517; fOH(i)=fOH(i)+0.03148844445486712; 
...
fISOP1OH2OOH(i)=fISOP1OH2OOH(i)-1; fMVK(i)=fMVK(i)+0.9837848780869679; fHCHO(i)=fHCHO(i)+0.9837848780869679; fHO2(i)=fHO2(i)+1.015948897544553; fOH(i)=fOH(i)+1.021037783654492; fCO(i)=fCO(i)+0.027342162285835192; fHAC(i)=fHAC(i)+0.00779322702076792; fMGLY(i)=fMGLY(i)+0.004309355437840154; fGLYX(i)=fGLYX(i)+0.0014521385955679146; fCO2(i)=fCO2(i)+0.005168666312304425; fCH3CO3(i)=fCH3CO3(i)+0.0039052179250246813; 
